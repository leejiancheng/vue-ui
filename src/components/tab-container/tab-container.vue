...
<template>
	<div @touchstart="startDrag" @mousedown="startDrag" @touchmove="onDrag" @mousemove="onDrag" @mouseleave="endDrag" @touchend="endDrag" class="mint-tab-container">
		<div class="mint-tab-container-wrap" ref="wrap">
			<slot></slot>
		</div>
	</div>
</template>
